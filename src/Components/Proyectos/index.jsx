    ...
    <MantineProvider withGlobalStyles withNormalizeCSS>
        ...
        <div className='proyectos__main-div'>
          ...
          <div className="proyectos__cards-div">
            ...
            <ProyectosCard linkTo={"https://tic-tac-toe-nu-steel.vercel.app/"} image="/Sin título.png" title="Tic Tac Toe" date="20/05/23" description="El proyecto TicTacToe fué creado con Vite + React, el cual requirió de la práctica de código javascript y cambios de estado de React. El juego cumple con todas las funcionalidades básicas requeridas incluyendo cambio de tema desde claro a oscuro. "/>
          </div>
        </div>
        <Footer />
